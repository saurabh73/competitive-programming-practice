...
public class TrailingZerosInFactorialTest {
    ...
    public void case1Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0030/input1.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0030/output1.txt");
        // Call Method Under Test
        ISolution problem = new TrailingZerosInFactorial();
    ...
    public void case2Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0030/input2.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0030/output2.txt");
        // Call Method Under Test
        ISolution problem = new TrailingZerosInFactorial();
        problem.solve(inputStream);
        //Assertion
