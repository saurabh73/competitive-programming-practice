...
public class LargestCoprimeDivisorTest {
    ...
    public void case1Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0033/input1.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0033/output1.txt");
    ...
    public void case2Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0033/input2.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0033/output2.txt");
        // Call Method Under Test
        ISolution problem = new LargestCoprimeDivisor();
        problem.solve(inputStream);
        //Assertion
    ...
    public void case3Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0033/input3.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0033/output3.txt");
        // Call Method Under Test
        ISolution problem = new LargestCoprimeDivisor();
        problem.solve(inputStream);
        //Assertion
