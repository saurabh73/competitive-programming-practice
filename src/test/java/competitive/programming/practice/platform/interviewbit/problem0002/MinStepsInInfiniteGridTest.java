...
public class MinStepsInInfiniteGridTest {
    ...
    public void case1Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0002/input1.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0002/output1.txt");
        // Call Method Under Test
        ISolution problem = new MinStepsInInfiniteGrid();
