...
public class MaxSumContiguousSubarrayTest {
    ...
    public void case1Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0023/input1.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0023/output1.txt");
        // Call Method Under Test
        ISolution problem = new MaxSumContiguousSubarray();
    ...
    public void case2Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/interviewbit/problem0023/input2.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/interviewbit/problem0023/output2.txt");
        // Call Method Under Test
        ISolution problem = new MaxSumContiguousSubarray();
        problem.solve(inputStream);
        //Assertion
