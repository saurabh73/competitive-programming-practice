...
public class SpiralMatrixTest {
    ...
    public void case1Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/geeksforgeeks/problem0005/input1.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/geeksforgeeks/problem0005/output1.txt");
        // Call Method Under Test
        ISolution problem = new SpiralMatrix();
    ...
    public void case2Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/geeksforgeeks/problem0005/input2.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/geeksforgeeks/problem0005/output2.txt");
        // Call Method Under Test
        ISolution problem = new SpiralMatrix();
        problem.solve(inputStream);
        //Assertion
