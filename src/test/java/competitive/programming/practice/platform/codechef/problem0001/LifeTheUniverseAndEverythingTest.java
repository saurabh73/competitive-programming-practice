...
public class LifeTheUniverseAndEverythingTest {
    ...
    public void case1Test() throws Exception {
        // Input
        InputStream inputStream = this.getClass().getResourceAsStream("/codechef/problem0001/input1.txt");
        // Output
        InputStream outPutStream = this.getClass().getResourceAsStream("/codechef/problem0001/output1.txt");
        // Call Method Under Test
        ISolution problem = new LifeTheUniverseAndEverything();
